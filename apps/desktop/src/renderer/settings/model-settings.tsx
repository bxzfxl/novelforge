  ...
  return (
    <div className="h-screen flex flex-col bg-nf-bg text-nf-text">
      <div className="flex items-center gap-4 px-6 py-4 border-b border-nf-border">
        ...
        <h1 className="text-lg font-semibold text-zinc-200">设置</h1>
      </div>
          ...
          <TabsContent value="models" className="space-y-4">
            ...
            {models.length === 0 ? (
              ...
              <div className="space-y-2">
                {models.map(model => (
                  <div key={model.id} className="flex items-center gap-4 p-4 bg-zinc-900 border border-zinc-800 rounded-lg">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-zinc-500 mt-0.5 truncate">{model.modelId}</div>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
