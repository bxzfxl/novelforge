...
function TreeNode({ item, depth = 0 }: { item: NavItem; depth?: number }) {
  ...
  return (
    <div>
      <div
        className="flex items-center gap-1 px-2 py-1 cursor-pointer hover:bg-white/5 rounded text-sm"
  ...
  return (
    <div className="h-full flex flex-col bg-zinc-950">
      <div className="px-3 py-2 border-b border-nf-border">
        <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">导航</span>
      </div>
